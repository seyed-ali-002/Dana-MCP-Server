...
def server_dashboard(settings: Any, mode: str, public_url: str | None = None) -> None:
    ...
    if public_url:
        ...
        console.print(Text(connect_url, style="bold green"), soft_wrap=True, overflow="ignore")
        console.print("[dim]Copy the complete URL above when connecting an MCP client.[/dim]")
